...
class RunServerChatCommand extends Command
{
    protected static $defaultName='startChatServer';
    protected function configure():void
    {
        $this
            ->setDescription('Starting chat service')
        ;
    }

...
// Unlock main lock
    ...
    /**
     * @Route("/rencontre/session/{rencontre}", name="app_wep_rtc")
     */
    public function hamatayzon(Request $request,Rencontre $rencontre)
    {
        ...
        return $this->render('web_rtc/index.html.twig', [
            ...
            'picture'=>'',
            'user'=>$user,
            'participants'=>$rencontre->getIdEvent()->getNbrParticipants(),
        ]);
    }

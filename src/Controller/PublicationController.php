...
class PublicationController extends AbstractController
{
    ...
    public function newpost(
        ...
        if ($img != null) {
            $publication->setImageFile(
                $request->files->get('publication')['imageFile']
            );
        } elseif (
            str_contains(
                $request->request->get('publication')['fichier'],
                '.gif'
            )
        ) {
            $publication->setFichier(
                $request->request->get('publication')['fichier']
            );
        } else {
    ...
    public function LoadForme(
        ...
        $publication->setDescription(
            $request->request->get('publication')['description']
        );
        $publication->setImageFile(
            $request->files->get('publication')['imageFile']
        );
